...
package com.sample.android.classytaxirabie.ui;
...
import com.sample.android.classytaxirabie.Constants;
import com.sample.android.classytaxirabie.SubApp;
import com.sample.android.classytaxirabie.billing.BillingUtilities;
import com.sample.android.classytaxirabie.data.SubscriptionStatus;
...
public class BillingViewModel extends AndroidViewModel {
    ...
    public void buyBasic() {
        boolean hasBasic = BillingUtilities.deviceHasGooglePlaySubscription(purchases.getValue(), Constants.BASIC_SKU);
        boolean hasPremium = BillingUtilities.deviceHasGooglePlaySubscription(purchases.getValue(), Constants.PREMIUM_SKU);
        Log.d("Billing", "hasBasic: " + hasBasic + ", hasPremium: " + hasPremium);
        if (hasBasic && hasPremium) {
