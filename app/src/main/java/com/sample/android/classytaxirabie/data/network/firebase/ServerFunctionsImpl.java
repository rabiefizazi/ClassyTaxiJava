...
package com.sample.android.classytaxirabie.data.network.firebase;
...
public class ServerFunctionsImpl implements ServerFunctions {
     ...
     */
    private List<SubscriptionStatus> insertOrUpdateSubscription( List<SubscriptionStatus> oldSubscriptions, SubscriptionStatus newSubscription) {
