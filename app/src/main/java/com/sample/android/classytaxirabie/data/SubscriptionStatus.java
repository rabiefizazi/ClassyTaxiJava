...
public class SubscriptionStatus {
    ...
    public static List<SubscriptionStatus> listFromMap(Map<String, Object> map) {
        ...
        for (Map<String, Object> subStatus : subList) {
            ...
            subscriptionStatus.activeUntilMillisec = (Long) subStatus.get(ACTIVE_UNTIL_MILLISEC_KEY);
    ...
    public static List<SubscriptionStatus> listFromJsonString(String dataString) {
        Gson gson = new Gson();
        try {
            SubscriptionStatusList subscriptionStatusList = gson.fromJson(dataString, SubscriptionStatusList.class);
